(function (root, $, undefined) {
  ...
  $(function () {
    ...
    function findSVG() {
      $(".flex-gallery img").each(function () {
        var imgsrc = $(this).attr("src");
        var fileExtension = imgsrc.substr(imgsrc.lastIndexOf(".") + 1);
        if (fileExtension == "svg") {
          $(this).parent().css("margin-bottom", "4em");
        }
      });
    }
    ...
    $(document).ready(function () {
      ...
      $(".downloadFinancials a").append(
        '<span class="downArrowContainer"><span class="downArrow">&nbsp;</span></span>'
      );

      $(".topLeftCaption")
        .find("figcaption")
        .wrap(
          '<div class="innerContainer absoluteCaptionInnerContainer"></div>'
        );

      // ADD GHOST CONTAINER
      $(".verticalStitchRight, .verticalStitchLeft").prepend(
        '<div class="ghostVertStitchContainer"></div>'
      );
