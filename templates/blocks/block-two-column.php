...
<?php endif; ?>
	...
	<div class="innerContainer<?php echo $offset, $rowwidth; if ( $section_padding ): echo $section_padding; endif; ?>">
		...
		<div class="row<?php if ( $gutterspacing ): echo $gutterspacing; else: ' gutter_space_2'; endif; if ( $reverse ): echo ' reverse'; endif; if ( $position ): echo ' '; echo $position; endif; ?>"<?php if ( $maxwidth ): echo ' style="max-width: '; echo $maxwidth; echo 'px;"'; endif; ?>>
			...
			<div<?php if ( $anchor ): echo ' id="'; echo $anchor; echo '"'; endif; if ($animatecol): echo ' data-aos="fade-up"'; endif; ?> class="col<?php echo $colwidth ?>col-sm-6 col-xs-12 bottomMarginMobile<?php echo $nobottommarginonmobile ?>">
